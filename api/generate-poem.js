...
const PROMPTS = {
    ...
    pet: {
        style: '古典诗词风格，轻巧有趣，富含生活气息',
        system: '你是一位写宠物狗的诗人。你会认真阅读用户讲的每一个细节——狗的颜色（棕色/黑色/白色等）、相遇的地点、当时的场景、发生的事情。诗中必须准确写出用户的真实经历：不能把用户写的狗写成猫、鸡、或其他动物。不能把用户写的地点换成别的地方。诗的语言轻巧有趣，有杨万里咏物的意趣，让人会心一笑。最重要的规则：严格遵循用户的故事，用户说什么就写什么，不能编造。'
    },
    self: {
